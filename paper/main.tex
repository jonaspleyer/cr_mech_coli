...
parameter.
\textbf{TODO adapt these last sentences to new results}
...
\begin{figure}[H]
    \centering
    \begin{tikzonimage}[width=0.49\textwidth]
        {figures/crm_fit/mie/snapshots/predicted-003889.png}%
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.49\textwidth]
        {figures/crm_fit/mie/celldiffs/diff-003889.png}%
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{B}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/damping.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/exponent-m.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/exponent-n.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/strength.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/radius.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-2.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{H}};
    \end{tikzonimage}%
    \caption{
        (A-H) Likelihood profiles of optimized parameters.
        Bands of blue and yellow represent confidence intervals of $68\%,90\%$ and $95\%$.
        \textbf{TODO adapt this description to new results}
        ...
        the supplementary material (Section~\ref{sec:supplement-parameter-profiles}).
    }
...
\begin{table}[H]
    ...
    \begin{tabular}{l c c c c c c}
        \multicolumn{4}{l}{\textbf{Growth Parameters for different Methods}}\\
        \toprule
        % \multicolumn{6}{Growth Rates}\\
        Method & Cell $0$ & Cell $1$ & Cell $2$ & Cell $3$ & Cell $4$ & Cell $5$\\
        \midrule
        Fit             & 0.00703 & 0.00540 & 0.01159 & 0.00756 & 0.01024 & 0.00836\\
        \ac{abm} Direct & 0.00671 & 0.00746 & 0.01138 & 0.00848 & 0.02005 & 0.00952\\
        \textbf{Imaging values will be adjusted!}\\
        \ac{abm} Imaging& 0.00104 & 0.00146 & 0.00206 & 0.00286 & 0.00190 & 0.00171\\
        & \textbf{Daughters}\\
        \midrule
        & Cell $0$ & Cell $1$ & Cell $2$ & Cell $3$ & Cell $4$ & Cell $5$\\
        & 0.00240 & 0.00494 & 0.00096 & 0.00363\\
        & 0.00490 & 0.00226 & 0.00448 & 0.00048\\
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-2.pdf}\\%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-3.pdf}%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-4.pdf}%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie/profiles/growth-rate-5.pdf}
