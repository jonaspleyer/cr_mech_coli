...
differences in the segmentation profile of two bacterial configurations.
...
Whenever two colors are not matching, a penalty of $p\in[0,1]$ is assigned for each point in the
pixel-grid.
...
This means that other models who potentially utilize very distinct cellular representations but are
