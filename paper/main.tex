...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.3\textwidth]
        ...
        \node at (0, 1)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {docs/source/_static/interaction.pdf}
        \node at (0, 1)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {docs/source/_static/mie-potential-shapes.pdf}
        \node at (0, 1)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.32\textwidth]
        ...
        \node at (0.025, 0.975)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.32\textwidth]
        {docs/source/_static/11571737453049821261/raw_pv/000000400.png}
        \node at (0.025, 0.975)[anchor=north west, rectangle, white, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.32\textwidth]
        {docs/source/_static/11571737453049821261/masks/000000400.png}
        \node at (0.025, 0.975)[anchor=north west, rectangle, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}
    \caption{
...
The initial configuration consists of 4 bacteria which grow and ultimately divide thus expanding
the filled up area.
Meanwhile figure~\ref{fig:benchmarking-extraction-algorithm} (I) shows a zoomed-in version of
snapshot (G), highlighting the direct comparison of the exact (dark cross) and extracted vertices.
...
point which is displayed in Figure~\ref{fig:benchmarking-extraction-algorithm}.
Here we can also see that the overall variance in the displacements increases directly after
division events.
However, the center of the distributions remain concentrated near zero without significant outliers
which demonstrates the robustness of our method in these densely packed scenarios.
Further details are given in the supplementary
materialsec:supsec:supplement-imaging-based-comparison-algorithm-details
(section~\ref{sec:supplement-imaging-based-comparison-algorithm-details}).

\paragraph{Determining the underlying Error Model}
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.36\textwidth]
        ...
        \node at (0.025, 0.975)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.36\textwidth]
        {docs/source/_static/fitting-methods/algorithm/mask-zoom.pdf}
        \node at (0.025, 0.975)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.255\textwidth]
        {docs/source/_static/fitting-methods/algorithm/interpolate-positions.pdf}
        \node at (0.025, 0.975)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}\\
    ...
    \begin{tikzonimage}[width=0.1625\textwidth]
        ...
        \node at (0.03, 0.99)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-003800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-005800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-007800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-009800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-007800-cropped.pdf}%
        \node at (0, 1)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{I}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-calculations.pdf}%
        \node at (0, 1)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-distribution.pdf}
        \node at (0, 1)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{K}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-fit-over-time.pdf}
        \node at (0, 1)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{L}};
    \end{tikzonimage}%
    \caption{
        ...
        (I) Average rod length of the exact and extracted data.
        ...
        (J) Displacement of individual vertices parallel and orthogonal to the rod.
        ...
        exclude outliers.
        (K) Mean $\mu_{p,o}$ and variance $\sigma_{p,o}$ of fitted normal distribution for
        displacements parallel and orthogonal to the rod displayed over the duration of the
        simulation.
    }
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.24\textwidth]
        ...
        \node at (0.025, 0.975)[anchor=north west, rectangle, white, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.24\textwidth]
    ...
    \begin{tikzonimage}[width=0.24\textwidth]
        ...
        \node at (0.025, 0.975)[anchor=north west, rectangle, white, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{minipage}{\textwidth}
        \begin{tikzonimage}[width=0.48\textwidth]
            {docs/source/_static/fitting-methods/extract_positionsdivision-comparison.pdf}
            \node at (0, 1)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{E}};
        \end{tikzonimage}%
        \hspace{0.01\textwidth}%
        \begin{tikzonimage}[width=0.48\textwidth]
            {docs/source/_static/fitting-methods/penalty-time-flow.pdf}
            \node at (0, 0.975)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{F}};
        \end{tikzonimage}%
    \end{minipage}
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.3\textwidth]
        ...
        \node at (0.02,17pt)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/progressions/step4-000017.png}
        \node at (0.02,17pt)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/progressions/step4-000034.png}
            \node at (0.01, 0.01+17pt)[anchor=north west, rectangle, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.33\textwidth]
    ...
    \begin{tikzonimage}[width=0.33\textwidth]
        ...
        \node at (0.13, 0.88)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.35\textwidth]
        ...
        \node at (0, 1)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.35\textwidth]
        {figures/crm_estimate_params/IWF-Goettingen/growth-rates-bar-plot.pdf}%
        \node at (0, 1)[anchor=north west, black, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.25\textwidth]
        ...
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/exponent-m.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/exponent-n.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/strength.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/radius.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/growth-rate-0.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/growth-rate-1.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/growth-rate-2.pdf}%
        \node at (0, 1.1)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.25\textwidth]
        ...
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000001.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000002.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000003.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000004.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000005.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000006.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000007.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000008.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{I}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000009.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000010.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{K}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles/profile-000011.png}%
        \node at (0.15, 0.85)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{L}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}
    ...
    \begin{tikzonimage}[width=0.5\textwidth]
        ...
        \node at (0.03, 0.99)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-distr-y.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-fit-over-time-covariance.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-distribution.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, black, minimum width=15pt, minimum height=15pt]{\textbf{I}};
    \end{tikzonimage}
    \caption{TODO}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/progressions/step4-000034.png}
        \node at (0.02,17pt)[anchor=north west, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}\\
    \vspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/result-full/0000000000.png}
        \node at (0.02, 0.98)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/result-full/0000000001.png}
        \node at (0.02, 0.98)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/result-full/0000000002.png}
        \node at (0.02, 0.98)[anchor=north west, rectangle, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \caption{
