...
In the first study, we utilize results previously obtained by \cite{Amir2014,Amir2014_2} who
investigated elastic deformations of \textit{E.Coli} that are partially trapped within a narrow
...
events.
In the first part, we utilize the direct comparison algorithm while the latter requires usage of the
