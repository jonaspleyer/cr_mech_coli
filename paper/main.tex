...
\pagebreak
\renewcommand{\contentsname}{Temporary! Table of Contents}
\tableofcontents
\pagebreak
...
\begin{figure}
    ...
    \caption{
        ...
        (B) The result of the  skeletonization algorithm when applying it to a single cell.
        (C) Extrapolated vertices $\vec{v}_i$ which represent the position of our cell-agents.
    }
...
% --------------------------------------------------------------------------------------------------
\subsubsection{Relationship to Semantic Segmentation}
...
% --------------------------------------------------------------------------------------------------
\section{Application to Mechanics of Rod-Shaped Bacteria}
