...
\begin{figure}[H]
    \centering
    \begin{tikzonimage}[width=0.49\textwidth]
        {figures/crm_fit/mie_all/snapshots/predicted-003889.png}%
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.49\textwidth]
        {figures/crm_fit/mie_all/celldiffs/diff-003889.png}%
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{B}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/damping.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/exponent-m.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/exponent-n.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/strength.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/radius.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-2.pdf}%
...
\begin{table}[H]
    ...
    \begin{tabular}{l c c c c c c}
        ...
        \toprule
        Exponential Fit & 0.00703 & 0.00540 & 0.01159 & 0.00756 & 0.01024 & 0.00836\\
        % \multicolumn{7}{l}{\textbf{Direct Position-Space Metric}}\\
        \midrule
        Direct \ac{abm} Mie    & 0.00671 & 0.00746 & 0.01138 & 0.00848 & 0.02005 & 0.00952\\
        Direct \ac{abm} Morse  & \textbf{TODO}\\
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-2.pdf}\\%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-3.pdf}%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-4.pdf}%
    \includegraphics[width=0.33\textwidth]
        {figures/crm_fit/mie_all/profiles/growth-rate-5.pdf}
