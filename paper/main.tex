...
However, in the strictly 2D case, where cells should not be able to hide behind each other, it is
...
Since such overlaps are unrealistic, we need to assign an additional penalty $p_o\geq0$ in this case.
