...
\begin{table}[H]
    ...
    \begin{tabular}{l c c l c c}
        ...
        \midrule
        Spring tension & $\gamma$ & $\unit{\per\minute}$ & Position (vertices) & $\vec{x}_i$ & $\unit{\micro\metre}$\\
...
equivalent to minimizing the \textit{log-likelihood} $L$ which is again equivalent to maximizing the
