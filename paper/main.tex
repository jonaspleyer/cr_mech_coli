...
allows us to sample a lower number of paremeters thus improving runtime performance of our
optimization scheme.
...
\begin{figure}[H]
    ...
    \caption{
        ...
        The remaining plots show similar behavior although with varying values and can be found in
...
Such behavior can be attributed to the missing images around the division events of the cells which
...
other individual cellular behaviors.
