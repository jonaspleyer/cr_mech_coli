...
Without any external interferrence, the bacteria will grow into straight rod-like
shapes~\cite{Wang2010}.
Our work focusses on smaller time scales where no plastic deformations are involved.

On longer time scales, this leads to an asymmetric, heterogeneous intracellular growth of the cell
which can result in plastic deformations~\cite{Ursell2014} for cells under constant tension.
Without any external interferrence, this type of growth will result in straight rod-shaped
bacteria~\cite{Wang2010}.
