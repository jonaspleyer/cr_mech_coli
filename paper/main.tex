...
For the presented model a list of parameters can be seen in table~\ref{table:list-of-parameters} but
the following calculations are equally true for any model with $N_p$ number of parameters.
Consider the case where we filter out a subset $N_g\leq N_p$ of parameters which will be treated
...
cells.
The total amount of parameters in the system is then given by
\begin{equation}
...
two distinct species of cells which should be displayed by 2 parameters in total regardless of the
number of cells.
