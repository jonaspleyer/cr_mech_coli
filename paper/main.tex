...
\begin{figure}[H]
    ...
    \caption{
        ...
        vertices (see \nameref{subsec:spatial-representation}).
...
(see \nameref{sec:supplement-morse-potential}).
...
comparison of the masks ($0.68(5)\%$) (see section \nameref{section:supplement-performance}).
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=\textwidth]
        {docs/source/_static/performance/flamegraph.pdf}
