...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.195\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-001800.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}%
    \hspace{0.005\textwidth}%
    \begin{tikzonimage}[width=0.195\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-003800.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \hspace{0.005\textwidth}%
    \begin{tikzonimage}[width=0.195\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-005800.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \hspace{0.005\textwidth}%
    \begin{tikzonimage}[width=0.195\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-007800.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}%
    \hspace{0.005\textwidth}%
    \begin{tikzonimage}[width=0.195\textwidth]
        {docs/source/_static/fitting-methods/extract_positions-009800.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}\\
    \hspace{0.005\textwidth}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-calculations.pdf}%
        \node at (0, 1)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{I}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-distribution.pdf}
        \node at (0, 1)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {docs/source/_static/fitting-methods/displacement-fit-over-time.pdf}
        \node at (0, 1)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{K}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.3\textwidth]
        {figures/crm_amir/progressions/step4-000034.png}
            \node at (0.01, 0.01+17pt)[anchor=north west, rectangle, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.33\textwidth]
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.49\textwidth]
        ...
        \node at (0.02, 0.98)[anchor=north west, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.49\textwidth]
        {figures/data/crm_fit/001044-markers.pdf}%
        \node at (0.02, 0.98)[anchor=north west, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{B}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.28\textwidth]
        {figures/crm_fit-data-progression.png}
        \node at (0.02, 0.98)[anchor=north west, draw, white, minimum width=15pt, minimum height=15pt]{\textbf{C}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.35\textwidth]
        {figures/crm_estimate_params/IWF-Goettingen/rod-lengths-individual.pdf}%
        \node at (0, 1)[anchor=north west, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{D}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.35\textwidth]
        {figures/crm_estimate_params/IWF-Goettingen/growth-rates-bar-plot.pdf}%
        \node at (0, 1)[anchor=north west, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{E}};
    \end{tikzonimage}%
    \caption{
...
\begin{figure}
    ...
    \begin{tikzonimage}[width=0.5\textwidth]
        ...
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-distr-y.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{G}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-fit-over-time-covariance.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{H}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {docs/source/_static/fitting-methods/displacement-distribution.pdf}
        \node at (0.03, 0.99)[anchor=north west, rectangle, draw, black, minimum width=15pt, minimum height=15pt]{\textbf{I}};
    \end{tikzonimage}
    \caption{TODO}
\end{figure}
